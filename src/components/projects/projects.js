	...
	render() {
		return (
			<div className="Projects section flex-container">
				<div className="item">
					<img src="./images/robofriends.png" alt="" className="thumb" />
					<div className="overlay">
						<div className="text">
							<h3>Robofriends</h3>
							<p className="ph5"><strong>Created a list of card elements using the React front end library and a functional search bar</strong></p>
				...
				<div className="item">
					...
					<div className="overlay">
						<div className="text">
							...
							<p className="ph5"><strong>Simple YouTube viewer using the youtube-search-api package and React</strong></p>
							<p>Javascript, React, Redux</p>
				...
				<div className="item">
					...
					<div className="overlay">
						<div className="text">
							<h3>Weather App</h3>
							<p className="ph5"><strong>Created a weather app that displays the current weather using the Dark Sky API</strong></p>
				...
				<div className="item">
					...
					<div className="overlay">
						<div className="text">
							...
							<p className="ph5"><strong>Created React app with backend components that store user credentials and recognize faces in images</strong></p>
				...
				<div className="item">
					...
					<div className="overlay">
						<div className="text">
							...
							<p className="ph5"><strong>Uses the Twitch.tv API to check if a prepopulated list of users is currently streaming</strong></p>
