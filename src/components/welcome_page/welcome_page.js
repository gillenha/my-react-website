	...
	render() {
		return(
			<div className="Welcome section tc">
				...
				<br />
				<a href="https://drive.google.com/file/d/1Zg-6WN6K1rAaJvaiyX94xAJhpDkZm_2S/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button className="resume-button">Resume</button></a>
			</div>
		)
	}
}
